...
<link href="../Vista/css/formularios_v3.css" rel="stylesheet" type="text/css">

  <header>
            <h1 class="site-heading text-center text-faded d-none d-lg-block">
                <span class="site-heading-lower">Empleado</span>
            </h1>
        </header>       
                   <form action="" method="post" name="login">
                           ...
                           <div class="form-group">
                              ...
                              <input type="text" placeholder="Ingresar la direccion" name="uname" required>
                           </div>
                           <div class="form-group">
