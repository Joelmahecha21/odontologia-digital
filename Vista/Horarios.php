...
<html lang="es">
    ...
    <body>
            <h1 class="site-heading text-center text-faded d-none d-lg-block">
                ...
                <span class="site-heading-lower">Consultorio Betsymar Celis</span>
            </h1>
        <!-- Navigation-->
                    ...
                    <div class="col-xl-9 mx-auto">
                        <div class="cta-inner bg-faded text-center rounded">
                            <h2 class="section-heading mb-5">
                                <span class="section-heading-upper">Venga a nuestro estableciento</span>
                            ...
                            <p class="address mb-5">
                                <em>
                                    <strong>Calle 53B nro 35A 05 Sur</strong>
                                    <br />
                                    Barrio Fátima,Tunjuelito
                                </em>
                            </p>
                            <p class="mb-0">
