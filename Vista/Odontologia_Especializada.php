...
<html lang="es">
    ...
    <body>
        ...
        <section class="page-section about-heading">
            <div class="container">
                <img class="img-fluid rounded about-heading-img mb-3 mb-lg-0" src="../Public/img/odontolog.jpg" alt="..." />
                <div class="about-heading-content">
                    <div class="row">
                        <div class="col-xl-9 col-lg-10 mx-auto">
                            <div class="bg-faded rounded p-5">
                                <h2 class="section-heading mb-4">
                                    <span class="section-heading-lower">ODONTOLOGIA GENERAL Y ESPECIALIZADA</span>
                                </h2>
                                <p>*Blanqueamento dental y diseño de sonrisa.</p>
                                <p>*Ortodoncia y ortopedia.</p>
                                <p>*Edodoncia.</p>
                                <p>*Periodoncia.</p>
                                <p>*Cirugia Oral.</p>
                                <p>*Rehabilitacion Oral.</p>
                                <p>*Implantologia.</p>
                            </div>
                        </div>
                    </div>
